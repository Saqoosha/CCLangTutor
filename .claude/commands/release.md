...
Release a new version of CCLangTutor with automatic version bump and release notes.
...
**Important:**
- Do NOT include a top-level title (e.g., `## CCLangTutor X.Y.Z`) — GitHub already shows the release title, so it would be duplicated
...
Display:
- New version number
- Release URL: `https://github.com/Saqoosha/CCLangTutor/releases/tag/v<new_version>`
